                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="kt_filter_search"
                                class="form-control form-control-solid w-250px ps-13" placeholder="Search houses..."
                                value="<?= esc($search) ?>" />
                        </div>
                        <!--end::Search-->
                    </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-house-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <i class="ki-duotone ki-plus fs-2"></i>Add House
                            </button>
                            <?php endif; ?>
                            <!--end::Add house-->
                        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_house_table">
                                    ...
                                    <th class="w-10px pe-2">
                                        <div
                                            ...
                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                data-kt-check-target="#kt_house_table .form-check-input"
                                                value="1" />
                                        </div>
                                    </th>
                                    <th class="min-w-20px">#</th>
                                    <th class="min-w-150px">House Name</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <small class="text-muted">#<?= esc($house['id']) ?></small>
                                        </div>
                                    </td>
                                    <!--end::ID-->
                                    ...
                                    <td>
                                        <?php if (!empty($house['color'])): ?>
                                        <div class="d-flex align-items-center">
                                            <div class="house-color-indicator me-2" style="background-color: <?= esc($house['color']) ?>;"></div>
                                            <span class="text-muted fs-7"><?= esc($house['color']) ?></span>
                                        </div>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <?php if (!empty($house['status_name'])): ?>
                                                ...
                                                ?>
                                                <?php if (!empty($house['status_color'])): ?>
                                                <span class="badge fw-bold" style="<?= $badgeStyle ?>">
                                                    <?= strtoupper(esc($house['status_name'])) ?>
                                                </span>
                                                <?php else: ?>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <?php if (!empty($house['created_by_name'])): ?>
                                            <span class="text-muted"><?= esc($house['created_by_name']) ?></span>
                                            <small
                                                class="text-muted"><?= date('d M Y \a\t H:i', strtotime($house['created_at'])) ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <!--end::Created By-->
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <?php if (!empty($house['updated_by_name']) && !empty($house['updated_at'])): ?>
                                            <span class="text-muted"><?= esc($house['updated_by_name']) ?></span>
                                            <small
                                                class="text-muted"><?= date('d M Y \a\t H:i', strtotime($house['updated_at'])) ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <!--end::Updated By-->
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3 view-house-btn"
                                                    data-house-id="<?= esc($house['id']) ?>">View</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <?php if ($permissions['canEdit']): ?>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3 edit-house-btn"
                                                    data-house-id="<?= esc($house['id']) ?>">Edit</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <?php if ($permissions['canDelete']): ?>
                                            <div class="menu-item px-3">
                                                <a class="menu-link px-3 delete-house-btn"
                                                    data-house-id="<?= esc($house['id']) ?>">Delete</a>
                                            </div>
                                            <?php endif; ?>
                                            <!--end::Menu item-->
                                        </div>
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-10">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div class="fw-bold text-gray-700 mb-2">No houses found</div>
                                            <div class="text-gray-500">Start by creating your first house entry</div>
                                        </div>
                                    </td>
                                </tr>
                                <!--end::No results-->
...
document.addEventListener('DOMContentLoaded', function() {
    const existingCards = document.querySelectorAll('#mobile-cards-container .mobile-house-card');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load initial houses for mobile
    const mobileContainer = document.getElementById('mobile-cards-container');
    if (mobileContainer) {
        // Only load initial data if container is empty (no server-rendered content)
        const existingCards = mobileContainer.querySelectorAll('.mobile-house-card');
        if (existingCards.length === 0) {
            loadHouses(false);
        }
            ...
            scrollTimeout = setTimeout(() => {
                if (!isLoading && hasMoreData) {
                    ...
                    if (scrollPosition >= documentHeight - 1000) {
                        loadHouses(false, mobileSearch?.value || '');
                    }
                }
            }, 100);
        });
    ...
    // Handle view house
    document.addEventListener('click', function(e) {
        if (e.target.closest('.view-house-btn')) {
            e.preventDefault();
            const houseId = e.target.closest('.view-house-btn').getAttribute('data-house-id');
            viewHouse(houseId);
        }
    });
    ...
    // Handle edit house
    document.addEventListener('click', function(e) {
        if (e.target.closest('.edit-house-btn')) {
            e.preventDefault();
            const houseId = e.target.closest('.edit-house-btn').getAttribute('data-house-id');
            editHouse(houseId);
        }
    });
    ...
    // Handle delete house
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-house-btn')) {
            e.preventDefault();
            const houseId = e.target.closest('.delete-house-btn').getAttribute('data-house-id');
            deleteHouse(houseId);
        }
    });
...
function loadHouses(reset = false, search = '') {
    if (isLoading) return;
    ...
    const url = `/houses/api?page=${currentPage}&limit=10&search=${encodeURIComponent(search)}`;
...
function renderHouses(houses) {
    ...
    houses.forEach((house, index) => {
        const houseCard = createHouseCard(house, (currentPage - 1) * 10 + index);
...
function createHouseCard(house, index) {
    ...
    const createdByName = house.created_by_name || 'System';
    ...
    const colorIndicator = house.color ? 
        `<div class="house-color-indicator me-2" style="background-color: ${house.color};" title="House Color: ${house.color}"></div>` : '';
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-warning btn-sm w-100 d-flex align-items-center justify-content-center view-house-btn" data-house-id="${house.id}">
                <i class="ki-duotone ki-eye fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-primary btn-sm w-100 d-flex align-items-center justify-content-center edit-house-btn" data-house-id="${house.id}">
                <i class="ki-duotone ki-pencil fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
    ...
    actionButtons += `
        <div class="col-4">
            <button class="btn btn-light-danger btn-sm w-100 d-flex align-items-center justify-content-center delete-house-btn" data-house-id="${house.id}">
                <i class="ki-duotone ki-trash fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    col.innerHTML = `
        <div class="card mobile-house-card" data-house-id="${house.id}">
            <div class="card-body p-4">
                <!-- House Header -->
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="flex-grow-1">
                        <small class="text-muted text-uppercase">#${house.id}</small>
                    </div>
                    <div class="ms-3 d-flex gap-2">
                        ${colorIndicator}
                        ${house.status_name ? `
                            ${house.status_color ? 
                                `<span class="badge fw-bold fs-8" style="background-color: ${house.status_color}1a; color: ${house.status_color};">${house.status_name.toUpperCase()}</span>` :
                                `<span class="badge badge-light-success fw-bold fs-8">${house.status_name.toUpperCase()}</span>`
                            }
                        ` : ''}
                        <span class="badge badge-light-primary fw-bold">HOUSE</span>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-start mb-4 mt-4">
                    <div class="flex-grow-1">
                        <strong class="me-5 text-uppercase text-truncate">${house.name}</strong>
                    </div>
                </div>
...
function viewHouse(houseId) {
    secureFetch(`/houses/show/${houseId}`)
        .then(response => {
            if (response.status === 401 || response.status === 403) {
                handleSessionExpired();
                return;
        ...
        .catch(error => {
            ...
            Swal.fire('Error', 'Failed to load house details', 'error');
        });
}
...
function deleteHouse(houseId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            secureFetch(`/houses/delete/${houseId}`, {
                    method: 'POST',
                    headers: {
...
function initMobileCards() {
    ...
    document.querySelectorAll('.mobile-house-card').forEach(function(card) {
...
function populateViewModal(house) {
    // Basic house info
    document.getElementById('view_house_name').textContent = house.name;
    
    // Handle color display
    const colorElement = document.getElementById('view_house_color');
    if (house.color) {
        colorElement.innerHTML = `
            <div class="d-flex align-items-center">
                <div class="house-color-indicator me-2" style="background-color: ${house.color};"></div>
                <span>${house.color}</span>
            </div>
        `;
    } else {
        colorElement.textContent = 'No color set';
    }
    
    // Description
    const description = document.getElementById('view_house_description');
    const descriptionSection = document.getElementById('view_house_description_section');
    ...
    // Handle status
    const statusElement = document.getElementById('view_house_status');
    if (house.status_name) {
        statusElement.innerHTML = `<span class="badge badge-light-primary">${house.status_name}</span>`;
    } else {
        statusElement.innerHTML = '<span class="badge badge-light-secondary">No Status</span>';
    }
    
    // Audit info
    document.getElementById('view_created_by').textContent = house.created_by_name || 'System';
    document.getElementById('view_created_at').textContent = house.created_at ? 
    ...
    const updatedBySection = document.getElementById('view_update_section');
    const updatedAtSection = document.getElementById('view_update_section_date');
    
    if (house.updated_by_name) {
        document.getElementById('view_updated_by').textContent = house.updated_by_name;
        if (updatedBySection) updatedBySection.style.display = 'block';
    } else {
        if (updatedBySection) updatedBySection.style.display = 'none';
    }
    
    if (house.updated_at) {
        document.getElementById('view_updated_at').textContent = new Date(house.updated_at).toLocaleDateString('en-US', { 
            year: 'numeric', 
            month: 'long', 
            day: 'numeric',
            hour: '2-digit',
        ...
        if (updatedAtSection) updatedAtSection.style.display = 'block';
    } else {
        if (updatedAtSection) updatedAtSection.style.display = 'none';
    }
    
    // Set house ID for edit button if it exists
    const editBtn = document.getElementById('view_edit_btn');
    if (editBtn) {
        editBtn.setAttribute('data-house-id', house.id);
    }
}

function populateEditModal(house) {
    document.getElementById('edit_house_id').value = house.id;
    document.querySelector('#editHouseForm input[name="name"]').value = house.name;
    document.querySelector('#editHouseForm input[name="color"]').value = house.color || '';
    document.querySelector('#editHouseForm textarea[name="description"]').value = house.description || '';
    
    // Set status dropdown
    const statusSelect = document.querySelector('#editHouseForm select[name="status_id"]');

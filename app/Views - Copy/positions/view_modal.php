<!--begin::View Position Modal-->
<div class="modal fade" id="viewPositionModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Position Details</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                        ...
                        <div class="card-body pt-4">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <h3 id="view_position_name" class="fw-bold mb-0">Position Name</h3>
                                </div>
                                <!--end::Position Name-->
                                ...
                                <div class="mb-4">
                                    ...
                                    <span id="view_section_name" class="badge badge-light-info fs-6">Section Name</span>
                                </div>
                                <!--end::Section Info-->

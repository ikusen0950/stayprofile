<!--begin::View Department Modal-->
<div class="modal fade" id="viewDepartmentModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <!--begin::Modal dialog-->
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card card-flush mb-6">
                        <div class="card-body pt-4">
                            <div class="d-flex flex-column">
                                <!--begin::Department Name-->
                                <div class="d-flex align-items-center mb-4">
                                    <h3 id="view_department_name" class="fw-bold mb-0">Department Name</h3>
                                </div>
                                <!--end::Department Name-->
                                ...
                                <div class="mb-4">
                                    ...
                                    <span id="view_division_name" class="badge badge-light-info fs-6">Division Name</span>
                                </div>
                                <!--end::Division Info-->

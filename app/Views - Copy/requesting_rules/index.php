                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php if (!empty($requestingRules)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($rule['division_names'])): ?>
                                                <?php foreach ($rule['division_names'] as $divisionName): ?>
                                                    <span class="badge badge-light-primary me-1 mb-1"><?= esc($divisionName) ?></span>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if (!empty($rule['department_names'])): ?>
                                                <?php foreach ($rule['department_names'] as $departmentName): ?>
                                                    <span class="badge badge-light-info me-1 mb-1"><?= esc($departmentName) ?></span>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <span class="text-muted">-</span>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            <?php if (!empty($rule['section_names'])): ?>
                                                <?php foreach ($rule['section_names'] as $sectionName): ?>
                                                    <span class="badge badge-light-warning me-1 mb-1"><?= esc($sectionName) ?></span>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <span class="text-muted">-</span>
                                            <?php endif; ?>

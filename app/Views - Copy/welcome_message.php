    ...
    <div class="heroe">
        ...
        <div style="margin-top: 30px;">
            <?php if (logged_in()) : ?>
                ...
                <a href="<?= base_url('dashboard') ?>" style="background: #dd4814; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin: 5px;">Go to Dashboard</a>
                <a href="<?= base_url('logout') ?>" style="background: #dc3545; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin: 5px;">Logout</a>
            <?php else : ?>
                <p>Experience the power of Myth Auth authentication system!</p>
                <a href="<?= base_url('login') ?>" style="background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin: 5px;">Login</a>
                <a href="<?= base_url('register') ?>" style="background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin: 5px;">Register</a>
                <a href="<?= base_url('dashboard') ?>" style="background: #ffc107; color: black; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin: 5px;">Try Protected Page</a>
            <?php endif; ?>
        </div>

...
<div class="d-lg-none">
    ...
    <div class="mobile-search-bar position-sticky top-0 py-3 mb-2" style="top: 60px !important;">
        <div class="container-fluid">
            <div class="mb-2">
                <h1 class="text-dark fw-bold ms-2">Departments</h1>
            </div>
                ...
                <div class="col-10">
                    <div class="position-relative h-100">
                        ...
                        <input type="text" id="mobile_search" class="form-control form-control-solid ps-10 h-100"
                            placeholder="Search departments..." value="<?= esc($search) ?>" />
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="btn btn-light-secondary w-100 h-100 d-flex align-items-center justify-content-center disabled"
                        style="min-height: 48px;" title="No permission to create departments">
    ...
    <div class="container-fluid" style="padding-top: 5px;">
        ...
        <div class="row mt-2" id="mobile-cards-container">
            ...
            <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>" data-aos-duration="600">
                <div class="card mobile-department-card" data-department-id="<?= esc($department['id']) ?>">
                    <div class="card-body p-4">
                        <!-- Department Header -->
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div class="flex-grow-1">
                                <small class="text-muted text-uppercase">#<?= esc($department['id']) ?></small>
                            </div>
                            <div class="ms-3 d-flex gap-2">
                                <?php if (!empty($department['status_name'])): ?>
                                    <?php 
                                    // Use custom color if available for mobile cards
                                    if (!empty($department['status_color'])) {
                                        // Convert hex color to RGB for light background
                                        $hex = ltrim($department['status_color'], '#');
                                        $r = hexdec(substr($hex, 0, 2));
                                        $g = hexdec(substr($hex, 2, 2));
                                        $b = hexdec(substr($hex, 4, 2));
                                        $lightBg = "rgba($r, $g, $b, 0.1)";
                                        $textColor = $department['status_color'];
                                        $mobileBadgeStyle = "background-color: $lightBg; color: $textColor;";
                                    } else {
                                        $mobileBadgeStyle = "";
                                    }
                                    ?>
                                    <?php if (!empty($department['status_color'])): ?>
                                    <span class="badge fw-bold fs-8" style="<?= $mobileBadgeStyle ?>">
                                        <?= strtoupper(esc($department['status_name'])) ?>
                                    </span>
                                    <?php else: ?>
                                ...
                                <span class="badge badge-light-primary fw-bold" style="padding: 4px 8px; font-size: 11px; line-height: 1.2;">
                                    <?= strtoupper(esc($department['name'])) ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-4 mt-4">
                            <div class="flex-grow-1">
                                <strong class="me-5 text-uppercase text-truncate"><?= esc($department['name']) ?></strong>
                                <?php if (!empty($department['division_name'])): ?>
                                <br>
                                <small class="text-primary fw-bold"><?= esc($department['division_name']) ?></small>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="d-flex flex-column">
                                <small class="text-muted">
                                    <?= !empty($department['created_by_name']) ? esc($department['created_by_name']) : 'System' ?>
                                </small>
                            </div>
                            <small class="text-muted"><?= date('M d, Y', strtotime($department['created_at'])) ?></small>
                        </div>
                        ...
                        <div class="mobile-actions mt-3 pt-3 border-top d-none">
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <button type="button"
                                        class="btn btn-light-warning btn-sm w-100 d-flex align-items-center justify-content-center view-department-btn"
                                ...
                                <div class="col-4">
                                    <button type="button"
                                        class="btn btn-light-primary btn-sm w-100 d-flex align-items-center justify-content-center edit-department-btn"
                                        data-department-id="<?= esc($department['id']) ?>">
                                ...
                                <div class="col-4">
                                    <button
                                        class="btn btn-light-danger btn-sm w-100 d-flex align-items-center justify-content-center delete-department-btn"
                                        data-department-id="<?= esc($department['id']) ?>">
            ...
            <div class="col-12">
                <div class="d-flex flex-column align-items-center justify-content-center py-10">
                    ...
                    <h6 class="fw-bold text-gray-700 mb-2">No departments found</h6>
        ...
        <div id="loading-indicator" class="text-center py-4 d-none">
            ...
            <p class="mt-2 text-muted">Loading more departments...</p>
        </div>

        <!-- No more data indicator -->
        <div id="no-more-data" class="text-center py-4 d-none">
            <p class="text-muted">No more departments to load</p>
        </div>
    </div>
</div>
<!--end::Mobile UI-->
                ...
                <div class="card">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="kt_filter_search"
                                    class="form-control form-control-solid w-250px ps-13" placeholder="Search departments..."
                                    value="<?= esc($search) ?>" />
                            </div>
                            <!--end::Search-->
                        </div>
                    ...
                    <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_department_table">
                                        ...
                                        <th class="w-10px pe-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                    data-kt-check-target="#kt_department_table .form-check-input"
                                                    value="1" />
                                            </div>
                                        </th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <small class="text-muted">#<?= esc($department['id']) ?></small>
                                            </div>
                                        </td>
                                        <!--end::ID-->
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <small class="fw-bold text-dark"><?= esc($department['division_name']) ?></small>
                                            </div>
                                        </td>
                                        <!--end::Division-->
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <?php if (!empty($department['created_by_name'])): ?>
                                                <span class="text-muted"><?= esc($department['created_by_name']) ?></span>
                                                <small
                                                    class="text-muted"><?= date('d M Y \a\t H:i', strtotime($department['created_at'])) ?></small>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <!--end::Created By-->
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <?php if (!empty($department['updated_by_name']) && !empty($department['updated_at'])): ?>
                                                <span class="text-muted"><?= esc($department['updated_by_name']) ?></span>
                                                <small
                                                    class="text-muted"><?= date('d M Y \a\t H:i', strtotime($department['updated_at'])) ?></small>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <!--end::Updated By-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 view-department-btn"
                                                        data-department-id="<?= esc($department['id']) ?>">View</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if ($permissions['canEdit']): ?>
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 edit-department-btn"
                                                        data-department-id="<?= esc($department['id']) ?>">Edit</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if ($permissions['canDelete']): ?>
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 delete-department-btn"
                                                        data-department-id="<?= esc($department['id']) ?>">Delete</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                            </div>
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-10">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <div class="fw-bold text-gray-700 mb-2">No departments found</div>
                        ...
                        $footerData = [
                            ...
                            'limit' => $limit,
                            'totalRecords' => $totalDepartments,
                            'search' => $search,
                            'tableId' => 'kt_department_table_length',
                            'jsFunction' => 'changeDepartmentTableLimit'
                        ];
...
<!-- Include Modals -->
<?= $this->include('departments/create_modal') ?>
<?= $this->include('departments/edit_modal') ?>
<?= $this->include('departments/view_modal') ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const existingCards = document.querySelectorAll('#mobile-cards-container .mobile-department-card');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load initial departments for mobile
    const mobileContainer = document.getElementById('mobile-cards-container');
    if (mobileContainer) {
        // Only load initial data if container is empty (no server-rendered content)
        const existingCards = mobileContainer.querySelectorAll('.mobile-department-card');
        if (existingCards.length === 0) {
            ...
            scrollTimeout = setTimeout(() => {
                if (!isLoading && hasMoreData) {
                    ...
                    if (scrollPosition >= documentHeight - 1000) {
                        loadDepartments(false, mobileSearch?.value || '');
                    }
                }
            }, 100);
        });
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.view-department-btn')) {
            e.preventDefault();
            const departmentId = e.target.closest('.view-department-btn').getAttribute('data-department-id');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.edit-department-btn')) {
            e.preventDefault();
            const departmentId = e.target.closest('.edit-department-btn').getAttribute('data-department-id');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-department-btn')) {
            e.preventDefault();
            const departmentId = e.target.closest('.delete-department-btn').getAttribute('data-department-id');
...
function loadDepartments(reset = false, search = '') {
    if (isLoading) return;
    ...
    const url = `/departments/api?page=${currentPage}&limit=10&search=${encodeURIComponent(search)}`;
...
function renderDepartments(departments) {
    ...
    departments.forEach((department, index) => {
        const departmentCard = createDepartmentCard(department, (currentPage - 1) * 10 + index);
...
function createDepartmentCard(department, index) {
    ...
    const description = department.description ?
        `<p class="text-muted mb-0 mt-3">${department.description}</p>` : '';

    const createdByName = department.created_by_name || 'System';
    const divisionName = department.division_name || 'No Division';

    const createdAt = new Date(department.created_at).toLocaleDateString('en-US', {
        month: 'short',
        day: '2-digit',
        year: 'numeric'
    });
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-warning btn-sm w-100 d-flex align-items-center justify-content-center view-department-btn" data-department-id="${department.id}">
                <i class="ki-duotone ki-eye fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-primary btn-sm w-100 d-flex align-items-center justify-content-center edit-department-btn" data-department-id="${department.id}">
                <i class="ki-duotone ki-pencil fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
    ...
    actionButtons += `
        <div class="col-4">
            <button class="btn btn-light-danger btn-sm w-100 d-flex align-items-center justify-content-center delete-department-btn" data-department-id="${department.id}">
                <i class="ki-duotone ki-trash fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    col.innerHTML = `
        <div class="card mobile-department-card" data-department-id="${department.id}">
            <div class="card-body p-4">
                <!-- Department Header -->
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="flex-grow-1">
                        <small class="text-muted text-uppercase">#${department.id}</small>
                    </div>
                    <div class="ms-3 d-flex gap-2">
                        ${department.status_name ? `
                            ${department.status_color ? 
                                `<span class="badge fw-bold fs-8" style="background-color: ${department.status_color}1a; color: ${department.status_color};">${department.status_name.toUpperCase()}</span>` :
                                `<span class="badge badge-light-success fw-bold fs-8">${department.status_name.toUpperCase()}</span>`
                            }
                        ` : ''}
                        <span class="badge badge-light-primary fw-bold" style="padding: 4px 8px; font-size: 11px; line-height: 1.2;">${department.name.toUpperCase()}</span>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-start mb-4 mt-4">
                    <div class="flex-grow-1">
                        <strong class="me-5 text-uppercase text-truncate">${department.name}</strong>
                        <br>
                        <small class="text-primary fw-bold">${divisionName}</small>
                    </div>
                </div>
...
function viewDepartment(departmentId) {
    secureFetch(`/departments/show/${departmentId}`)
        .then(response => {
            if (response.status === 401 || response.status === 403) {
                handleSessionExpired();
                return;
...
function deleteDepartment(departmentId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            secureFetch(`/departments/delete/${departmentId}`, {
                    method: 'POST',
                    headers: {
...
function initMobileCards() {
    ...
    document.querySelectorAll('.mobile-department-card').forEach(function(card) {
...
function populateViewModal(department) {
    // Basic department info
    document.getElementById('view_department_name').textContent = department.name;
    document.getElementById('view_division_name').textContent = department.division_name || 'N/A';
    ...
    // Audit info
    document.getElementById('view_created_by').textContent = department.created_by_name || 'System';
    document.getElementById('view_created_at').textContent = department.created_at ? 
    ...
    if (department.updated_by_name) {
        document.getElementById('view_updated_by').textContent = department.updated_by_name;
    ...
    if (department.updated_at) {
        document.getElementById('view_updated_at').textContent = new Date(department.updated_at).toLocaleDateString('en-US', { 
            year: 'numeric', 
            month: 'long', 
            day: 'numeric',
            hour: '2-digit',
    ...
    // Set department ID for edit button if it exists
    const editBtn = document.getElementById('view_edit_btn');
    if (editBtn) {
        editBtn.setAttribute('data-department-id', department.id);
    }
}

function populateEditModal(department) {
    document.getElementById('edit_department_id').value = department.id;
    document.querySelector('#editDepartmentForm input[name="name"]').value = department.name;
    document.querySelector('#editDepartmentForm select[name="division_id"]').value = department.division_id;
    document.querySelector('#editDepartmentForm textarea[name="description"]').value = department.description || '';

    // Set status dropdown
    const statusSelect = document.querySelector('#editDepartmentForm select[name="status_id"]');
    if (statusSelect && department.status_id) {
        statusSelect.value = department.status_id;
    ...
    // Trigger Select2 update if it's initialized
    const divisionSelect = document.querySelector('#editDepartmentForm select[name="division_id"]');
    if (divisionSelect && typeof $(divisionSelect).select2 === 'function') {
        $(divisionSelect).trigger('change');
    }
}

// Change table limit (records per page)
function changeDepartmentTableLimit(newLimit) {

...
<div class="modal fade" id="editModuleModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y p-4">
                <!--begin::Form-->
                <form id="editModuleForm" class="form">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="edit_module_name" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter module name" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select id="edit_status_id" name="status_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select a status..." data-dropdown-parent="#editModuleModal">
                                <option></option>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea id="edit_module_description" name="description" class="form-control form-control-solid" rows="4" placeholder="Enter module description (optional)"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
            ...
            <div class="modal-footer flex-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <button type="button" class="btn btn-primary" id="editModuleSubmitBtn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const submitBtn = document.getElementById('editModuleSubmitBtn');
    ...
    if (editForm && submitBtn) {
        submitBtn.addEventListener('click', function(e) {
            ...
            if (!moduleId) {
                Swal.fire('Error', 'Module ID not found', 'error');
                return;
            }
            ...
            secureFetch(`/modules/update/${moduleId}`, {
                method: 'POST',
                body: formData,
                headers: {
...
function openEditModal(module) {
    ...
    document.getElementById('edit_status_id').value = module.status_id;

...
<head>
    <title>Change Password - Islanders App</title>
    <meta charset="utf-8" />
    <meta name="description"
        content="Change your password - Islanders App - Streamlining Island Life with Seamless Digital Solutions" />
    <meta name="keywords" content="islanders, password, change, security, island, digital solutions" />
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
    <meta name="theme-color" content="#1f2129">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Change Password - Islanders App" />
    <meta property="og:description" content="Update your account password for enhanced security" />
...
<body id="kt_body" class="app-blank">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/assets/media/hotel/hotel_image_1.jpg" class="d-block" alt="Slide 1"
                                    loading="eager">
                            </div>
                            <div class="carousel-item">
                                <img src="/assets/media/hotel/hotel_image_2.jpg" class="d-block" alt="Slide 2"
                                    loading="lazy">
                            </div>
                            <div class="carousel-item">
                                <img src="/assets/media/hotel/hotel_image_3.jpg" class="d-block" alt="Slide 3"
                                    loading="lazy">
                            </div>
                        </div>
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        <form class="form w-100" novalidate="novalidate" action="<?= base_url('change-password') ?>"
                            method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="text-center mb-10">
                                <h1 class="text-gray-900 mb-3">Change Your Password</h1>
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="password-strength">
                                    ...
                                    <div class="text-muted fs-7" id="password-strength-text">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input
                                    class="form-control form-control-lg form-control-solid <?php if (session('errors.password_confirm')) : ?>is-invalid<?php endif ?>"
                                ...
                                <div class="text-muted fs-7 mt-2" id="password-match-text"></div>
                            </div>

                            <!-- Error message container -->
                            <div id="password-error-container" class="alert alert-danger d-none mb-5">
                                <span id="password-error-message"></span>
                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-lg btn-primary" id="change-password-btn">
                                    <i class="ki-duotone ki-shield-tick fs-2 me-1">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                    Change Password
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Mark our form to prevent auth.js interference
        if (changePasswordForm) {
            changePasswordForm.dataset.customHandler = 'true';
        }
        ...
        function updatePasswordStrength() {
            ...
            if (password.length === 0) {
                ...
                strengthText.className = 'text-danger fs-7';
            } else if (score === 2) {
                strengthFill.classList.add('fair');
                strengthText.textContent = 'Fair - Include: ' + feedback.join(', ');
                strengthText.className = 'text-warning fs-7';
            } else if (score === 3 || score === 4) {
                strengthFill.classList.add('good');
                strengthText.textContent = 'Good password strength';
                strengthText.className = 'text-success fs-7';
            } else if (score === 5) {
        ...
        function checkPasswordMatch() {
            ...
            if (confirmPassword.length === 0) {
                ...
                matchText.className = 'text-muted fs-7 mt-2';
            } else if (password === confirmPassword) {
                matchText.textContent = '✓ Passwords match';
                matchText.className = 'text-success fs-7 mt-2';
            } else {
                matchText.textContent = '✗ Passwords do not match';
                matchText.className = 'text-danger fs-7 mt-2';
            }
        }
        ...
        if (changePasswordForm) {
            changePasswordForm.addEventListener('submit', function(e) {
                // Prevent the generic auth.js handler from interfering
                ...
                if (score < 3) {
                    e.preventDefault();
                    showError('Please choose a stronger password. Your password should include uppercase letters, lowercase letters, numbers, and special characters.');
                    return false;
                }
                ...
                if (submitBtn) {
                    ...
                    // Reset button state after timeout (in case of server error)
                    setTimeout(() => {
        ...
        // Mobile keyboard handling (same as login page)

...
<html lang="en">
<head>
    <title>Sign In - Islanders App</title>
    <meta charset="utf-8" />
    <meta name="description" content="Sign in to Islanders App - Streamlining Island Life with Seamless Digital Solutions" />
    <meta name="keywords" content="islanders, login, signin, island, digital solutions" />
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
    <meta name="theme-color" content="#1f2129">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Sign In - Islanders App" />
    <meta property="og:description" content="Access your island community resources and connect with fellow islanders" />
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        <form class="form w-100" novalidate="novalidate" action="<?= url_to('login') ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="text-center mb-10">
                                <h1 class="text-gray-900 mb-3">Sign In to Islanders App</h1>
                                <?php if ($config->allowRegistration) : ?>
                                <div class="text-gray-500 fw-semibold fs-4">
                                    New Here?
                                    <a href="/register" class="link-primary fw-bold">Create an Account</a>
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-lg form-control-solid <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>"
                                    type="email" name="login" placeholder="<?= lang('Auth.email') ?>" />
                                <div class="invalid-feedback"><?= session('errors.login') ?></div>
                            </div>
                            <?php else: ?>
                            <div class="fv-row mb-10">
                                <label class="form-label fs-6 fw-bold text-gray-900 autofocus"><?= lang('Auth.emailOrUsername') ?></label>
                                <input class="form-control form-control-lg form-control-solid <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>"
                                    type="text" name="login" placeholder="<?= lang('Auth.emailOrUsername') ?>" />
                                <div class="invalid-feedback"><?= session('errors.login') ?></div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="fv-row mb-10">
                                <div class="d-flex flex-stack mb-2">
                                    <label class="form-label fw-bold text-gray-900 fs-6 mb-0"><?= lang('Auth.password') ?></label>
                                </div>
                                ...
                                <div class="mt-2 text-end">
                                    ...
                                    <a href="/forgot" class="link-primary fs-6 fw-bold">Forgot Password ?</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-lg btn-dark w-100 mb-5"><?= lang('Auth.loginAction') ?></button>
                            </div>
                        </form>
                    </div>
                </div>

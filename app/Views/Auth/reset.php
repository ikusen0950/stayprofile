...
<html lang="en">
<head>
    <title>Reset Password - Islanders App</title>
    <meta charset="utf-8" />
    ...
    <meta name="keywords" content="islanders, password reset, reset password, island, digital solutions" />
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
    <meta name="theme-color" content="#1f2129">
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Reset Password - Islanders App" />
    <meta property="og:description" content="Set your new password and regain access to your account" />
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        <form class="form w-100" novalidate="novalidate" action="<?= url_to('reset-password') ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="text-center mb-10">
                                <h1 class="text-gray-900 mb-3"><?= lang('Auth.resetYourPassword') ?></h1>
                            ...
                            <div class="fv-row mb-10">
                                <label class="form-label fs-6 fw-bold text-gray-900"><?= lang('Auth.token') ?></label>
                                <input class="form-control form-control-lg form-control-solid <?php if (session('errors.token')) : ?>is-invalid<?php endif ?>"
                                    type="text" name="token" placeholder="<?= lang('Auth.token') ?>" value="<?= old('token', $token ?? '') ?>" />
                            ...
                            <div class="fv-row mb-10">
                                <label class="form-label fs-6 fw-bold text-gray-900"><?= lang('Auth.newPassword') ?></label>
                                <input class="form-control form-control-lg form-control-solid <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>"
                                    placeholder="<?= lang('Auth.newPassword') ?>" type="password" name="password" autocomplete="off" />
                                <div class="invalid-feedback"><?= session('errors.password') ?></div>
                            </div>

                            <div class="fv-row mb-10">
                                <label class="form-label fs-6 fw-bold text-gray-900"><?= lang('Auth.newPasswordRepeat') ?></label>
                                <input class="form-control form-control-lg form-control-solid <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>"
                                    placeholder="<?= lang('Auth.newPasswordRepeat') ?>" type="password" name="pass_confirm" autocomplete="off" />
                                <div class="invalid-feedback"><?= session('errors.pass_confirm') ?></div>
                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-lg btn-dark w-100 mb-5"><?= lang('Auth.resetPassword') ?></button>
                                <a href="<?= url_to('login') ?>" class="btn btn-lg btn-light w-100">Back to Sign In</a>
                            </div>
                        </form>
                    </div>
                </div>

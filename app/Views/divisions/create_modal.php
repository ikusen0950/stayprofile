    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="modal-title" id="createDivisionModalLabel">
            ...
            <div class="modal-body">
                <!--begin::Form-->
                <form id="createDivisionForm" action="/divisions/store" method="POST">
                    <!--begin::Scroll-->
                    <div class="scroll-y" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" 
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold mb-2 required">Division Name</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" 
                                   name="name" id="division_name" placeholder="Enter division name" required />
                            <!--end::Input-->
                            <!--begin::Error message container-->
                            <div class="text-danger mt-2 d-none" id="division_name_error"></div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea class="form-control form-control-solid" name="description" 
                                      id="division_description" rows="4" 
                                      placeholder="Enter division description (optional)"></textarea>
                            <!--end::Input-->
                            <!--begin::Error message container-->
                            <div class="text-danger mt-2 d-none" id="division_description_error"></div>
                            <!--end::Error message container-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select class="form-select form-select-solid" name="status_id" id="division_status_id" required>
                            ...
                            <!--end::Select-->
                            <!--begin::Error message container-->
                            <div class="text-danger mt-2 d-none" id="division_status_id_error"></div>
                            <!--end::Error message container-->
                        </div>
                        <!--end::Input group-->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="createDivisionForm" class="btn btn-primary" id="createDivisionBtn">
                    <i class="ki-duotone ki-check fs-2">
                        <span class="path1"></span>
                        <span class="path2"></span>
                    </i>
                    <span class="indicator-label">Create Division</span>
...
<!--end::Create Division Modal-->

<script>
document.addEventListener('DOMContentLoaded', function() {
    const createForm = document.getElementById('createDivisionForm');
    const createBtn = document.getElementById('createDivisionBtn');
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        ...
                        // Reload page to show new division
                    ...
                    if (data.errors) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: data.message || 'Failed to create division'
                        });
                    }
                }
            })

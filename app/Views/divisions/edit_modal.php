    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="modal-title" id="editDivisionModalLabel">
                    ...
                    <div class="scroll-y" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" 
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" 
                                   name="name" id="edit_division_name" placeholder="Enter division name" required />
                            <!--end::Input-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select class="form-select form-select-solid" name="status_id" id="edit_division_status_id" required>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="editDivisionForm" class="btn btn-warning" id="editDivisionBtn">
                    <i class="ki-duotone ki-pencil fs-2">
                        <span class="path1"></span>
                        <span class="path2"></span>
                    </i>
                    <span class="indicator-label">Update Division</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (editForm && editBtn) {
        editForm.addEventListener('submit', function(e) {
            ...
            const divisionId = document.getElementById('edit_division_id').value;
            
            // Submit via fetch
            secureFetch(`/divisions/update/${divisionId}`, {
                method: 'POST',
                body: formData,
                headers: {
                ...
                if (data.success) {
                    ...
                    if (data.errors) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: data.message || 'Failed to update division'
                        });
                    }
                }
            })

...
<div class="d-lg-none">
    ...
    <div class="mobile-search-bar position-sticky top-0 py-3 mb-2" style="top: 60px !important;">
        <div class="container-fluid">
            <div class="mb-2">
                <h1 class="text-dark fw-bold ms-2">Roles</h1>
            </div>
                ...
                <div class="col-10">
                    <div class="position-relative h-100">
                        ...
                        <input type="text" id="mobile_search" class="form-control form-control-solid ps-10 h-100"
                            placeholder="Search roles..." value="<?= esc($search) ?>" />
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <div class="btn btn-light-secondary w-100 h-100 d-flex align-items-center justify-content-center disabled"
                        style="min-height: 48px;" title="No permission to create roles">
    ...
    <div class="container-fluid" style="padding-top: 5px;">
        ...
        <div class="row mt-2" id="mobile-cards-container">
            ...
            <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>" data-aos-duration="600">
                <div class="card mobile-role-card" data-role-id="<?= esc($role['id']) ?>">
                    <div class="card-body p-4">
                        <!-- Role Header -->
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div class="flex-grow-1">
                                <small class="text-muted text-uppercase">#<?= esc($role['id']) ?></small>
                            </div>
                            <div class="ms-3">
                                <span class="badge badge-light-primary fw-bold">
                                    <?= strtoupper(esc($role['name'])) ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-4 mt-4">
                            <div class="flex-grow-1">
                                <strong class="me-5 text-uppercase text-truncate"><?= esc($role['name']) ?></strong>
                                <?php if (!empty($role['description'])): ?>
                                <p class="text-muted mb-0 mt-2"><?= esc($role['description']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mobile-actions mt-3 pt-3 border-top d-none">
                            <div class="row g-2">
                                ...
                                <div class="col-4">
                                    <button type="button"
                                        class="btn btn-light-warning btn-sm w-100 d-flex align-items-center justify-content-center view-role-btn"
                                ...
                                <div class="col-4">
                                    <button type="button"
                                        class="btn btn-light-primary btn-sm w-100 d-flex align-items-center justify-content-center edit-role-btn"
                                        data-role-id="<?= esc($role['id']) ?>">
                                ...
                                <div class="col-4">
                                    <button
                                        class="btn btn-light-danger btn-sm w-100 d-flex align-items-center justify-content-center delete-role-btn"
                                        data-role-id="<?= esc($role['id']) ?>">
            ...
            <div class="col-12">
                <div class="d-flex flex-column align-items-center justify-content-center py-10">
                    ...
                    <h6 class="fw-bold text-gray-700 mb-2">No roles found</h6>
                    <p class="fs-7 text-gray-500 mb-4">Start by creating your first role entry</p>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div id="loading-indicator" class="text-center py-4 d-none">
            ...
            <p class="mt-2 text-muted">Loading more roles...</p>
        </div>

        <!-- No more data indicator -->
        <div id="no-more-data" class="text-center py-4 d-none">
            <p class="text-muted">No more roles to load</p>
        </div>
    </div>
</div>
<!--end::Mobile UI-->
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_role_table">
                                        ...
                                        <th class="w-10px pe-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                    data-kt-check-target="#kt_role_table .form-check-input"
                                                    value="1" />
                                            </div>
                                        </th>
                                        <th class="min-w-20px">#</th>
                                        <th class="min-w-100px">Role Name</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <small class="text-muted">#<?= esc($role['id']) ?></small>
                                            </div>
                                        </td>
                                        <!--end::ID-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 view-role-btn"
                                                        data-role-id="<?= esc($role['id']) ?>">View</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if ($permissions['canEdit']): ?>
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 edit-role-btn"
                                                        data-role-id="<?= esc($role['id']) ?>">Edit</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if ($permissions['canDelete']): ?>
                                                <div class="menu-item px-3">
                                                    <a class="menu-link px-3 delete-role-btn"
                                                        data-role-id="<?= esc($role['id']) ?>">Delete</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                            </div>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-10">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <div class="fw-bold text-gray-700 mb-2">No roles found</div>
                                                <div class="text-gray-500">Start by creating your first role entry
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        $footerData = [
                            ...
                            'search' => $search,
                            'tableId' => 'kt_role_table_length',
                            'jsFunction' => 'changeRoleTableLimit'
                        ];
...
<!-- Include Modals -->
<?= $this->include('roles/create_modal') ?>
<?= $this->include('roles/edit_modal') ?>
<?= $this->include('roles/view_modal') ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const existingCards = document.querySelectorAll('#mobile-cards-container .mobile-role-card');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load initial roles for mobile
    const mobileContainer = document.getElementById('mobile-cards-container');
    if (mobileContainer) {
        // Only load initial data if container is empty (no server-rendered content)
        const existingCards = mobileContainer.querySelectorAll('.mobile-role-card');
        if (existingCards.length === 0) {
            loadRoles(false);
        }
            ...
            scrollTimeout = setTimeout(() => {
                if (!isLoading && hasMoreData) {
                    ...
                    if (scrollPosition >= documentHeight - 1000) {
                        loadRoles(false, mobileSearch?.value || '');
                    }
                }
            }, 100);
        });
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.view-role-btn')) {
            e.preventDefault();
            const roleId = e.target.closest('.view-role-btn').getAttribute('data-role-id');
            viewRole(roleId);
        }
    });
...
function loadRoles(reset = false, search = '') {
    if (isLoading) return;
    ...
    const url = `/roles/api?page=${currentPage}&limit=10&search=${encodeURIComponent(search)}`;
...
function renderRoles(roles) {
    ...
    roles.forEach((role, index) => {
        const roleCard = createRoleCard(role, (currentPage - 1) * 10 + index);
...
function createRoleCard(role, index) {
    ...
    const description = role.description ?
        `<p class="text-muted mb-0 mt-2">${role.description}</p>` : '';
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-warning btn-sm w-100 d-flex align-items-center justify-content-center view-role-btn" data-role-id="${role.id}">
                <i class="ki-duotone ki-eye fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    actionButtons += `
        <div class="col-4">
            <button type="button" class="btn btn-light-primary btn-sm w-100 d-flex align-items-center justify-content-center edit-role-btn" data-role-id="${role.id}">
                <i class="ki-duotone ki-pencil fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
    ...
    actionButtons += `
        <div class="col-4">
            <button class="btn btn-light-danger btn-sm w-100 d-flex align-items-center justify-content-center delete-role-btn" data-role-id="${role.id}">
                <i class="ki-duotone ki-trash fs-1 me-2">
                    <span class="path1"></span>
                    <span class="path2"></span>
                    <span class="path3"></span>
    ...
    col.innerHTML = `
        <div class="card mobile-role-card" data-role-id="${role.id}">
            <div class="card-body p-4">
                <!-- Role Header -->
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="flex-grow-1">
                        <small class="text-muted text-uppercase">#${role.id}</small>
                    </div>
                    <div class="ms-3">
                        <span class="badge badge-light-primary fw-bold">${role.name.toUpperCase()}</span>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-start mb-4 mt-4">
                    <div class="flex-grow-1">
                        <strong class="me-5 text-uppercase text-truncate">${role.name}</strong>
                        ${description}
                    </div>
                </div>
...
function deleteRole(roleId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            secureFetch(`/roles/delete/${roleId}`, {
                    method: 'POST',
                    headers: {
...
function initMobileCards() {
    ...
    document.querySelectorAll('.mobile-role-card').forEach(function(card) {
...
function populateViewModal(role) {
    ...
    // Set role ID for edit button if it exists
...
function populateEditModal(role) {
    ...
    document.querySelector('#editRoleForm input[name="name"]').value = role.name;
    document.querySelector('#editRoleForm textarea[name="description"]').value = role.description || '';
}

// Change table limit (records per page)
function changeRoleTableLimit(newLimit) {

<!--begin::View Nationality Modal-->
<div class="modal fade" id="viewNationalityModal" tabindex="-1" aria-labelledby="viewNationalityModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header">
                <h2 class="modal-title" id="viewNationalityModalLabel">
            ...
            <div class="modal-body">
                ...
                <div class="scroll-y" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" 
                    ...
                    <!--begin::Nationality Information-->
                    <div class="card mb-6">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="fw-bold">Nationality Information</h3>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-8">
                                    <span class="fw-bold text-gray-800" id="view_nationality_name">-</span>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" id="view_edit_btn" data-nationality-id="">
...
<!--end::View Nationality Modal-->

<script>
document.addEventListener('DOMContentLoaded', function() {
    // Handle edit button in view modal
    const viewEditBtn = document.getElementById('view_edit_btn');
    const viewModal = document.getElementById('viewNationalityModal');
    
    if (viewEditBtn) {
        viewEditBtn.addEventListener('click', function() {
            const nationalityId = this.getAttribute('data-nationality-id');
            if (nationalityId) {
                // Hide view modal
